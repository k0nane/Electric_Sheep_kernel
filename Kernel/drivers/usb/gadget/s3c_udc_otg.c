...
#include "s3c_udc.h"
#include "fsa9480_i2c.h"//// ansari_L&T_FROYO_CL534716
...
#define DEBUG_S3C_UDC_SETUP // ansari_L&T_FROYO_CL534716
...
extern int currentusbstatus;// ansari_L&T_FROYO_CL534716
...
{
	if (currentusbstatus == USBSTATUS_VTP)// ansari_L&T_FROYO_CL534716
...
static int s3c_udc_resume(struct platform_device *pdev)
{
	...
	if (dev->driver) {
#if 0 //ansari_L&T_FROYO_CL534716
