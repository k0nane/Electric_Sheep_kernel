	...
	if (acl_enable != value)	{
		...
		if (acl_enable == 1)	{
			...
			switch (current_gamma_value)	{
				case 0:
				case 1:
					s6e63m0_panel_send_sequence(ACL_cutoff_set[13]); //set 65% ACL
					cur_acl = 65;
					printk(" ACL_cutoff_set Percentage : 65!!\n");
					break;
				case 2:
				case 3:
                    s6e63m0_panel_send_sequence(ACL_cutoff_set[12]); //set 60% ACL
					cur_acl = 60;
					printk(" ACL_cutoff_set Percentage : 60!!\n");
					break;
				case 4:
				case 5:
				case 6:
					s6e63m0_panel_send_sequence(ACL_cutoff_set[11]); //set 55% ACL
					cur_acl = 55;
					printk(" ACL_cutoff_set Percentage : 55!!\n");
					break;
				case 7:
				case 8:
				case 9:
				case 10:
					s6e63m0_panel_send_sequence(ACL_cutoff_set[10]); //set 50% ACL
					cur_acl = 50;
...
static int s5p_bl_update_status(struct backlight_device* bd)
{
	...
	switch (level)	{
		case BACKLIGHT_LEVEL_DIMMING:
			...
			if (cur_acl != 65)	{
					s6e63m0_panel_send_sequence(ACL_cutoff_set[13]); //set 65% ACL
							gprintk(" ACL_cutoff_set Percentage : 65!!\n");
							cur_acl = 65;
				}
			}
#endif
				...
				switch (gamma_value)	{
						 ...
						 if (cur_acl != 60)
							{
								s6e63m0_panel_send_sequence(ACL_cutoff_set[12]); //set 60% ACL
								cur_acl = 60;
								gprintk(" ACL_cutoff_set Percentage : 60!!\n");
							}
							break;
					case 4:
					case 5:
					case 6:
                    				if (cur_acl != 55)
						{
							s6e63m0_panel_send_sequence(ACL_cutoff_set[11]); //set 55% ACL
							cur_acl = 55;
							gprintk(" ACL_cutoff_set Percentage : 55!!\n");
						}
                         			break;
					case 7:
					case 8:
