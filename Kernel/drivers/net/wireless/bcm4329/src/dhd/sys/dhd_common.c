...
dhd_preinit_ioctls(dhd_pub_t *dhd)
{
	...
	int roam_trigger[2];
    int wsec = 3; //jwj 2010.11.26 for sgs certification - Disable WEP & TKIP connection with 11n rates 
	...
	/* Roam Trigger Setting */
	roam_trigger[0] = -75-8;
	roam_trigger[1] = WLC_BAND_AUTO;
   ...
   /* Disable WEP & TKIP connection with 11n rates */
    bcm_mkiovar("ht_wsec_restrict", (char *)&wsec, 4, iovbuf, sizeof(iovbuf));
    dhdcdc_set_ioctl(dhd, 0, WLC_SET_VAR, iovbuf, sizeof(iovbuf));
