...
//#define DELAY_PRX 1
#define GP2A_RECOMMENDED_MODE_B1

#define IRQ_GP2A_INT IRQ_EINT1  /*s3c64xx int number */
...
#define ADC_CHANNEL  6 /* index for s5pC110 9번 channel adc */
