...
#include <linux/delay.h>   // fixed CQ G0100212514
...
u8 max8998_cache_regs[0x40] = {
	...
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xEE/* YUNG LDO4(VADC) Enabled by BootLoader 0xED*/, 0xB8, 0x00, 0xF9, //0x11
				...
				const struct i2c_device_id *i2c_id)
{
	...
	//lpm_mode_check(); /* TODO */
	// [ fixed CQ G0100212514
   Set_MAX8998_PM_REG(ELDO5,0);
   mdelay(200);
   // fixed CQ G0100212514 ]
   
	Set_MAX8998_PM_OUTPUT_Voltage(LDO5, VCC_2p800);
	Set_MAX8998_PM_REG(ELDO5,1);

    /* SLEEP_CURRENT CHOI@HW_REQ REV01 */
	// TODO:YUNG_SLEEP_CURRENT DK09 Set_MAX8998_PM_OUTPUT_Voltage(BUCK3, VCC_2p000);
