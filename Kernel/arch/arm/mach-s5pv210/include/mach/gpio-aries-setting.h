...
static unsigned int jupiter_gpio_table[][8] =
{
   ...
   {S5PV210_GPA0(5), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE, /* KEY_SCAN(6) */
         S3C_GPIO_DRVSTR_3X, S3C_GPIO_SLEWRATE_FAST, 0, 0},
	...
	//		 S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},
#if !defined(CONFIG_FORTE_VER_B1)
	...
	{S5PV210_GPA1(3), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE, /* KEY_SCAN[7] */
			 S3C_GPIO_DRVSTR_3X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},
	...
	{S5PV210_GPD0(0), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN,
        ...
        {S5PV210_GPD0(1), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN,
			 S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},
        {S5PV210_GPD0(2), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE, /*  MSENSE_nRST */ // GPIO_STATE_CHECK
          S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},
	...
	{S5PV210_GPJ0(0), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN,
        ...
        {S5PV210_GPJ1(1), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN,
			 S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},
        {S5PV210_GPJ1(2), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE,     /* MICBIAS_EN */
			 S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},
        {S5PV210_GPJ1(3), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE,
			 S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},
        {S5PV210_GPJ1(4), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN,     /* NC */
			 S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},
...
#endif
	/* memory part */
	{S5PV210_MP01(0), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE, /* MAIN_KEY_LED */
			 S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},
	...
	{S5PV210_MP04(0), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE,/* For new MAIN_KEY_LED of HW 0.7 */
			 S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},
	...
	{S5PV210_MP05(0), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN,
        ...
        {S5PV210_MP05(6), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN,
			 S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},
#if 0 // TODO:FORTE EMUL_REV02 (9/18) /* UART_SEL */
...
static unsigned int jupiter_sleep_gpio_table[][3] =
{
	{S5PV210_GPA0(0), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},
    	...
    	{S5PV210_GPA0(5), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_UP},    /* KEY_SCAN(6) */
	...
	{S5PV210_GPA1(0), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},
    	...
    	{S5PV210_GPA1(3), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_UP},  /* KEY_SCAN(7) */
	...
	{S5PV210_GPE0(0), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},      /* CAM_PCLK */
        ...
        {S5PV210_GPE0(4), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},
        {S5PV210_GPE0(5), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},
        {S5PV210_GPE0(6), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},
        {S5PV210_GPE0(7), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* CAM_D(4) */

	{S5PV210_GPE1(0), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},
        {S5PV210_GPE1(1), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},
	...
	{S5PV210_GPG0(0), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},       /* NAND_CLK */
        ...
        {S5PV210_GPG0(2), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},  /* AP_PMIC_SCL */
	...
	{S5PV210_GPG3(0), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},  /* FM_SDA */
        {S5PV210_GPG3(1), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* MASSMEMORY_EN HW PULL_DOWN */
        ...
        {S5PV210_GPG3(6), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},  /* PMIC_SDA */
	...
	{S5PV210_GPJ0(0), S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE},          /* POPUP_SW_EN */
        ...
        {S5PV210_GPJ0(2), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},      /* NC */
    ...
    // TODO:FORTE //DPRAM
	{S5PV210_GPJ2(0), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},
        ...
        {S5PV210_GPJ2(7), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},
	...
	{S5PV210_GPJ4(0), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_UP},        /* DPRAM_CS_N */
        {S5PV210_GPJ4(1), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_UP},    /* EBI2_WE_N */
	    {S5PV210_GPJ4(2), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_UP},    /* EBI2_OE_N */
	...
	{S5PV210_MP01(0), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},   /* MAIN_KEY_LED_EN */
