...
#if defined(CONFIG_S5PV210)
	onedram_base = (void __iomem *)ONEDRAM1G_SHARED_AREA_VIRT;
	onedram_sem  = onedram_base + 0xFFF800;
	onedram_mailboxAB = onedram_base + 0xFFF800 + 0x20;
	onedram_mailboxBA = onedram_base + 0xFFF800 + 0x40;
