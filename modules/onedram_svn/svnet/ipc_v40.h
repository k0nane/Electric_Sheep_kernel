...
**********************************************************************************/
typedef enum{
  IPC_FACTORY_AUTO_TEST_CDMA = 0x01,        /* 0x01 : Auto Test for CDMA Message */
  IPC_FACTORY_AUTO_TEST_GSM,                /* 0x02 : Auto Test for GSM Message  */
  IPC_FACTORY_PDA_FORCE_SLEEP,              /* 0x03 : PDA Force Sleep Mode Message */
  IPC_FACTORY_BT_TEST,                      /* 0x04 : BT Factory Test Message */
  IPC_FACTORY_WIFI_TEST,                    /* 0x05 : Wi-fi Test Message */
  IPC_FACTORY_FM_RADIO_TEST,                /* 0x06 : FM Radio Test Message */             
  IPC_FACTORY_MEM_FORMAT_TEST,              /* 0x07 : Memory Format Test Message*/
  IPC_FACTORY_LINE_MODE_SMS_COUNT,          /* 0x08 : Line SMS Count Message*/
  IPC_FACTORY_LINE_MODE_SMS_READ,           /* 0x09 : Line SMS Read Message*/
  IPC_FACTORY_G_SENSOR_TEST,                 /* 0x0A : G-SENSOR Test Message*/
  IPC_FACTORY_MEM_SIZE_CHECK,               /* 0X0B : Memory Size Check Message*/
  IPC_FACTORY_MEM_FILE_NUM_CHECK,           /* 0x0C : Memory File Number Check Message*/
  IPC_FACTORY_DIAG_TOUCH_TEST,              /* 0x0D : Diagnostic Touch Test Message*/
  IPC_FACTORY_LINE_MODE,                          /* 0x0E : Line Mode Message */
  IPC_FACTORY_TRANSFER_FRAME_BUFFER,       /* 0x0F : Transfer Frame Buffer(Screen Capture)*/
  IPC_FACTORY_SHIPMENT_TEST,                      /*0x10: Shipment Test*/
  #ifdef FEATURE_SAMSUNG_DOMESTIC //  ipc    CYE
  IPC_FACTORY_SDMB_TEST,
  IPC_FACTORY_WIBRO_TEST,
  IPC_FACTORY_WIBRO_BOOT_IMAGE_WRITE,
  IPC_FACTORY_PDA_VERSION,
  IPC_FACTORY_LOCKCODE_INIT,
  #endif
//#ifdef FEATURE_SAMSUNG_FACTORY_PROCESS_CHECK
  IPC_FACTORY_PROCESS_TEST,		/*0x11: Factory Process Test*/ //    
//#endif  
  IPC_FACTORY_AP_THERMISTOR,        /*0x12: Thermistor Test*/
  IPC_FACTORY_AP_BATT_CALIBRATION,	/*0x13 : Battery Calibration*/
  IPC_FACTORY_PATTERN_LOCK,         /*0x14 : Reset Pattern Lock*/ //reset_patternlock
	IPC_FACTORY_STA_MODE,				/*0x15 : STA MODE*/ // gideonj_dc02 HQRL_ED11 - STA MODE
/* SMS Input / Read Data   Pineone hgwoo*/
  IPC_FACTORY_SMS_INPUT=0x15, /* 0x15 : SMS Input DFT List */
  IPC_READ_AUTO_FULL_DATA_CMD, /* 0x16 : Read Data DFT List */
// [[ SecFeature.SPRINT_DFT : keytrace pineon_dsseo Start 2010_02_19
  IPC_FACTORY_KEYTRACE,             /*0x17 : keytrace */ //etinum.keytrace
// pineon_dsseo End ]] 
//20100306 hgwoo Fuel Gauge Sub Diag Command Implemented..
  IPC_FACTORY_AP_FUEL_GAUGE_CALIBRATION,
  IPC_FACTORY_WIFI_ON_OFF_TEST,                      /*cyj_dc09 0x19 : WIFI Factory On Off Test Message */
  IPC_FACTORY_SD_CHECK,								// 0x1A SecFeature.SPRINT_DFT : PINEONE_ADS29 SD Card Check 
  IPC_FACTORY_FACTORY_RESET_COMPLETE,
  IPC_FACTORY_WIFI_MACADDR,                      /*cyj_dc24: WIFI Factory On Off Test Message */
  IPC_FACTORY_GET_UNIQUE_NUMBER,				/* 0x1d Unique number */
  IPC_FACTORY_SELECTIVE_RESET_COMPLETE,
  IPC_FACTORY_MAX
