...
#define FMT_OUT    0x000004
#define FMT_OUT_SZ 0x1000  /* 4 KB */
#define FMT_IN     0x401014
#define FMT_IN_SZ  0x1000  /* 4 KB */

#define RAW_OUT    0x00100C
#define RAW_OUT_SZ 0x400000 /* 4 MB */
#define RAW_IN     0x40201C
#define RAW_IN_SZ  0x400000 /* 4 MB */

#define RFS_OUT    0x802024
#define RFS_OUT_SZ 0x40000 /* 256 KB */
#define RFS_IN     0x84202C
#define RFS_IN_SZ  0x40000 /* 256 KB */

#define SIPC_MAP_SIZE 0xF00000 /* 15 MB */
